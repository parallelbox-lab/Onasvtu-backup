...
function GetAmount() {
    ...
    if (strMobileNetwork == "15") {
        ...
        opt.value = "1";
        opt.innerHTML = "75MB  - (1 day)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "2";
        opt.innerHTML = "200MB - 1 day";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "3";
        opt.innerHTML = "1 GB  - 1 day";
        cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "7";
        opt.innerHTML = "4.5 GB  - 7 days";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "8";
        opt.innerHTML = "8 GB  - 30 days";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "9";
        opt.innerHTML = "15 GB  - 30 days";
        cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "1";
        opt.innerHTML = "1.5GB-N1000(30 days)";
        cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "2";
        opt.innerHTML = "2GB-N1200(30 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "3";
        opt.innerHTML = "4.5GB-N2000(30 days)";
        cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "4";
        opt.innerHTML = "40GB-N10000(30 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "5";
        opt.innerHTML = "75GB-N25000(90 days)"; //3 GB - 30 days
        cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "6";
        opt.innerHTML = "165GB-N50000(180 days)";
        cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "7";
        opt.innerHTML = "365GB-N100000(365 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "8";
        opt.innerHTML = "11GB-N4000(30 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "9";
        opt.innerHTML = "25MB-N50(1 day)";
        cboDataBundle.appendChild(opt);
    } else if (strMobileNetwork == "AirTel") {

        opt = document.createElement('option');
        opt.value = "10";
        opt.innerHTML = "100MB-N100(1 day)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "11";
        opt.innerHTML = "650MB-N200(1 day)";
        cboDataBundle.appendChild(opt);

        //opt = document.createElement('option');
        //opt.value = "1";opt.innerHTML = "5 GB";
        //cboDataBundle.appendChild(opt);

        //opt = document.createElement('option');
        //opt.value = "16";opt.innerHTML = "7 GB";
        //cboDataBundle.appendChild(opt);

        //opt = document.createElement('option');
        //opt.value = "2";opt.innerHTML = "9 GB";
        //cboDataBundle.appendChild(opt);
        ...
        opt = document.createElement('option');
        opt.value = "4";
        opt.innerHTML = "75GB-N15000(30 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "13";
        opt.innerHTML = "15GB-N5000(30 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "14";
        opt.innerHTML = "100GB-N84992(100 days)";
        cboDataBundle.appendChild(opt);

        opt = document.createElement('option');
        opt.value = "15";
        opt.innerHTML = "7GB1W-N1500(7 days)";
        cboDataBundle.appendChild(opt);
...
function GetAmount2() {
    ...
    var myStoreName = 'onasvtu';
    if (myStoreName = 'onasvtu') {

<html lang="en">
  <head>
    <title>Onasvtu - forget password</title>
    <meta charset="utf-8">
...
<body ng-controller="AppCtrl" class="ng-scope">
    ...
    <form action="<?php echo base_url();?>account/resetlink" method="post"  class="access-box" name="loginForm" enctype="multipart/form-data">
    <?php echo @$error; ?>

        <h1 class="access-box-title text-center m-b-lg ng-binding">Forget password</h1>
<?=$this->session->flashdata('message');?>
      
        <div class="form-group mt-2">
            <input type="email" name="email" id="forget_email" class="form-control i-text" placeholder="Your Email..">
        </div>
        <div class="form-group">
            <button class="btn-s" name="forgot_pass"><span class="default-state">SEND RESET LINK</span></button>
        </div>
    </form>
...
$('#action_forget_password').click(function(){
    ...
    $.post("<?php echo base_url('account/forget_password'); ?>",
    {

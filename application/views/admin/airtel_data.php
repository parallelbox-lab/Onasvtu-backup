...
<section class="au-breadcrumbs m-t-75" style="background: #F1FEF4;padding:20px;">
    ...
    <div class="rounded p-4">
        ...
        <!-- Mobile Recharge -->
                ...
                <h2 class=" mb-3 text-center">Buy Airtel DataBundle</h2>
                                    <br/>
                            <form action="<?php echo base_url();?>dashboard/airtel-data" method="post" id="form1" name="form1">
...
<input type="hidden" value="<?php echo $balance['balance']; ?>" name="bal">
    ...
    <button class="bt btn-primary btn-block" onclick="sharedata()" id="sbut" type="submit" name="button">Buy Data</button>
